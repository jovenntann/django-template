...
# Serializers
from .serializers import ReadUserStoreSerializer
...
class UsersIdStoresAPIView(APIView):
    ...
    @swagger_auto_schema(
        responses={
            200: ReadUserStoreSerializer()
        },
        operation_description="description",
        operation_id="users_stores_read.",
    ...
    def get(request, user_id=None):
        ...
        if user_object is None:
            raise Http404
        user_serializer = ReadUserStoreSerializer(user_object)
