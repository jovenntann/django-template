...
class ReadStoreSerializer(serializers.ModelSerializer):
    class Meta:
        ref_name = "StoreManagementStoresId_ReadStoreSerializer"
        model = Store
        fields = [
            'id',
            'user',
...
class DeleteStoreSerializer(serializers.Serializer): # noqa
    class Meta:
        ref_name = "StoreManagementStoresId_DeleteStoreSerializer"
...
class UpdateStoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "StoreManagementStoresId_UpdateStoreSerializer"
        model = Store
        fields = [
            'name',
            'contact_number',
