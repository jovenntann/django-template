...
class ReadCategorySerializer(serializers.ModelSerializer):
    class Meta:
        ref_name = "ProductManagementCategoriesId_ReadCategorySerializer"
        model = Category
        fields = [
            'id',
            'name',
...
class UpdateCategorySerializer(serializers.ModelSerializer): # noqa
    ...
    class Meta:
        ref_name = "ProductManagementCategoriesId_UpdateCategorySerializer"
        model = Category
        fields = [
            'id',
            'name',
...
class DeleteCategorySerializer(serializers.Serializer): # noqa
    ...
    class Meta:
        ref_name = "ProductManagementCategoriesId_DeleteCategorySerializer"
