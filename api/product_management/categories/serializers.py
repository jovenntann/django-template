...
class ReadCategorySerializer(serializers.ModelSerializer):
    class Meta:
        ref_name = "ProductManagementCategories_ReadCategorySerializer"
        model = Category
        fields = [
            'id',
            'name',
...
class CreateCategorySerializer(serializers.ModelSerializer):
    class Meta:
        ref_name = "ProductManagementCategories_CreateCategorySerializer"
        model = Category
        fields = [
            'name',
            'description'
...
class PaginateReadCategorySerializer(serializers.Serializer): # noqa
    ...
    class Meta:
        ref_name = "ProductManagementCategories_PaginateReadCategorySerializer"
...
class PaginateQueryReadCategorySerializer(serializers.Serializer): # noqa
    ...
    class Meta:
        ref_name = "ProductManagementCategories_PaginateQueryReadCategorySerializer"
