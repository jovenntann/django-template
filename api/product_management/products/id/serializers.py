...
class ReadCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "ProductManagementProductsId_ReadCategorySerializer"
        model = Category
        fields = [
            'id',
            'name',
...
class ReadProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "ProductManagementProductsId_ReadProductSerializer"
        model = Product
        fields = [
            'id',
            'store',
...
class UpdateProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ref_name = "ProductManagementProductsId_UpdateProductSerializer"
        model = Product
        fields = [
            'store',
            'categories',
...
class DeleteProductSerializer(serializers.Serializer): # noqa
    ...
    class Meta:
        ref_name = "ProductManagementProductsId_DeleteProductSerializer"
