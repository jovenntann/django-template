...
class ProductsAPIView(APIView):
    ...
    def get(request):
        ...
        result_page = paginator.paginate_queryset(product_objects, request)
    ...
    def post(request, pk=None, *args, **kwargs):
        ...
        if product_serializer.is_valid(raise_exception=True):
            product_object = create_product(
                product_serializer.validated_data.get('store'),
                product_serializer.validated_data.get('categories', []),
                product_serializer.validated_data.get('title'),
                product_serializer.validated_data.get('description'),
            )
